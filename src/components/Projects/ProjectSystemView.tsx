...
// const ProjectSystemView = ({ project }: ProjectSystemViewProps) => {
//     return (
//         <div className="p-6 md:p-12 border-t border-dashed border-border-color grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12">
...
//                         <div key={i} className="p-4 border border-border-color bg-bg-primary">
...
//                 {/* Links */}
//                 <div className="flex flex-col gap-3 font-mono text-xs pt-4 border-t border-dashed border-border-color">
//                     <a href={project.githubUrl} target="_blank" className="flex items-center gap-2 text-text-muted hover:text-accent transition-colors">
//                         [ VIEW SOURCE CODE ]
//                     </a>
//                     {project.liveUrl && (
//                         <a href={project.liveUrl} target="_blank" className="flex items-center gap-2 text-text-muted hover:text-accent transition-colors">
//                             [ OPEN DEPLOYMENT ]
//                         </a>
//                     )}
//                 </div>
...
//             {/* RIGHT COLUMN: ARCHITECTURE & ANALYSIS */}
//             <div className="space-y-12 min-w-0">
                
//                 {/* 1. Architecture Diagram (ReactFlow) */}
//                 <div className="h-75 w-full border border-border-color bg-bg-primary relative rounded-sm overflow-hidden">
...
//                         panOnDrag={false}
//                     >
//                         {/* Adjusted Background color to match theme */}
//                         <Background gap={24} size={1} color="#1f2229" /> 
//                         <Controls showInteractive={false} className="bg-surface! border-border-color! [&>button]:fill-text-muted!" />
//                     </ReactFlow>
//                 </div>
...
//                             <FiXCircle size={16} />
//                             <span className="font-mono text-xs uppercase tracking-wide">Post-Mortem / Mistakes</span>
//                         </div>
//                         <ul className="space-y-2">
//                             {project.caseStudy.details.mistakes.map((m, i) => (
//                                 <li key={i} className="text-sm text-text-muted leading-relaxed list-disc list-inside marker:text-error">
//                                     {m}
//                                 </li>
//                             ))}
//                         </ul>
...
//                             <span className="font-mono text-xs uppercase tracking-wide">Tradeoffs Accepted</span>
//                         </div>
//                         <ul className="space-y-2">
//                             {project.caseStudy.details.tradeoffs.map((t, i) => (
//                                 <li key={i} className="text-sm text-text-muted leading-relaxed list-disc list-inside marker:text-accent">
//                                     {t}
//                                 </li>
//                             ))}
//                         </ul>
...
// src/components/Projects/ProjectSystemView.tsx
// Update the imports
